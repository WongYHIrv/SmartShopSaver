...
public class FilterReportProductAdmin extends Filter {
     ...
     */
    public FilterReportProductAdmin(AdapterReportProductAdmin adapter, ArrayList<ModelReportProduct> filterList) {
    ...
    protected FilterResults performFiltering(CharSequence constraint) {
        ...
        if (constraint != null && constraint.length() > 0) {
            ...
            ArrayList<ModelReportProduct> filteredModels = new ArrayList<>();
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        ...
        adapter.reportProductArrayList = (ArrayList<ModelReportProduct>) results.values;
