...
public class FilterProductCategoryAdmin extends Filter {
     ...
     */
    public FilterProductCategoryAdmin(AdapterProductCategoryAdmin adapter, ArrayList<ModelProductCategory> filterList) {
    ...
    protected FilterResults performFiltering(CharSequence constraint) {
        ...
        if (constraint != null && constraint.length() > 0) {
            ...
            ArrayList<ModelProductCategory> filteredModels = new ArrayList<>();
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        ...
        adapter.productCategoryArrayList = (ArrayList<ModelProductCategory>) results.values;
