...
public class FilterProductCategoryUser extends Filter {
     ...
     */
    public FilterProductCategoryUser(AdapterProductCategoryUser adapter, ArrayList<ModelProductCategory> filterList) {
