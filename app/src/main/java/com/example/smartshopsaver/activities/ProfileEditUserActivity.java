...
import com.example.smartshopsaver.databinding.ActivityProfileEditUserBinding;
        ...
        binding.toolbarGpsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isGPSEnabled()) {
                    ...
                    MyUtils.toast(ProfileEditUserActivity.this, "Turn on Location...!");
                }
            }
        });
            ...
            new ActivityResultCallback<Map<String, Boolean>>() {
                ...
                public void onActivityResult(Map<String, Boolean> result) {
                    ...
                    if (areAllGranted) {
                        ...
                        MyUtils.toast(ProfileEditUserActivity.this, "Camera or Storage or both permissions denied...");
                    }
                }
            }
    );
    ...
    private LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationAvailability(@NonNull LocationAvailability locationAvailability) {
            ...
            if (locationAvailability.isLocationAvailable()) {
                MyUtils.toast(ProfileEditUserActivity.this, "Location Available!");
            } else {
                MyUtils.toast(ProfileEditUserActivity.this, "Location Not Available!");
            }
        }
            ...
            new ActivityResultCallback<Boolean>() {
                ...
                public void onActivityResult(Boolean isGranted) {
                    ...
                    if (isGranted) {
                        ...
                        MyUtils.toast(ProfileEditUserActivity.this, "Storage permission denied...!");
                    }
                }
            }
    );
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        //Cancelled
                        MyUtils.toast(ProfileEditUserActivity.this, "Cancelled...");
                    }
                }
            }
    );
        ...
        ref.putFile(imageUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        MyUtils.toast(ProfileEditUserActivity.this, "Failed to upload profile image due to " + e.getMessage());
                    }
                });
    }
        ...
        ref.child("" + uid).updateChildren(hashMap)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //failed updating db
                        progressDialog.dismiss();
                        MyUtils.toast(ProfileEditUserActivity.this, "Failed to update due to " + e.getMessage());
                    }
                });
    }
