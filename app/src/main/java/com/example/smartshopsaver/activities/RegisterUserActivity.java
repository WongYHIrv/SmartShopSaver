...
import com.example.smartshopsaver.databinding.ActivityRegisterUserBinding;
...
public class RegisterUserActivity extends AppCompatActivity {
        ...
        binding.toolbarGpsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isGPSEnabled()) {
                    ...
                    MyUtils.toast(RegisterUserActivity.this, "Turn on Location...!");
                }
            }
        });
            ...
            new ActivityResultCallback<Map<String, Boolean>>() {
                ...
                public void onActivityResult(Map<String, Boolean> result) {
                    ...
                    if (areAllGranted) {
                        ...
                        MyUtils.toast(RegisterUserActivity.this, "Camera or Storage or both permissions denied...");
                    }
                }
            }
    );
    ...
    private LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationAvailability(@NonNull LocationAvailability locationAvailability) {
            ...
            if (locationAvailability.isLocationAvailable()) {
                MyUtils.toast(RegisterUserActivity.this, "Location Available!");
            } else {
                MyUtils.toast(RegisterUserActivity.this, "Location Not Available!");
            }
        }
            ...
            new ActivityResultCallback<Boolean>() {
                ...
                public void onActivityResult(Boolean isGranted) {
                    ...
                    if (isGranted) {
                        ...
                        MyUtils.toast(RegisterUserActivity.this, "Storage permission denied...!");
                    }
                }
            }
    );
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        //Cancelled
                        MyUtils.toast(RegisterUserActivity.this, "Cancelled...");
                    }
                }
            }
    );
    ...
    private String fullName, phoneNumber, country, state, city, address, email, password, confirmPassword, fcmToken = "";
        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        MyUtils.toast(RegisterUserActivity.this, "Failed due to " + e.getMessage());
        ...
        ref.putFile(imageUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Log.e(TAG, "onFailure: ", e);
                        progressDialog.dismiss();
                        MyUtils.toast(RegisterUserActivity.this, "Failed to upload profile image due to " + e.getMessage());
                    }
                });
    }
    ...
    private void updateUserInfo(String uploadedImageUrl) {
        ...
        hashMap.put("accountType", "" + Constants.USER_TYPE_USER);
