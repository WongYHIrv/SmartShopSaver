...
import com.example.smartshopsaver.databinding.RowBrochureSellerBinding;
import com.example.smartshopsaver.filters.FilterBrochureSeller;
...
public class AdapterBrochureSeller extends RecyclerView.Adapter<AdapterBrochureSeller.HolderBrochureSeller> implements Filterable {

    //View Binding
    private RowBrochureSellerBinding binding;
    ...
    private FilterBrochureSeller filter;
     ...
     */
    public AdapterBrochureSeller(Context context, ArrayList<ModelBrochure> brochureArrayList) {
    ...
    public HolderBrochureSeller onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //inflate/bind the row_brochure_seller.xml
        binding = RowBrochureSellerBinding.inflate(LayoutInflater.from(context), parent, false);
    ...
    private void optionsDialog(ModelBrochure modelCategory, HolderBrochureSeller holder) {
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == 1) {
                    //Edit clicked: start BrochureAddSellerActivity
                    Intent intent = new Intent(context, BrochureAddSellerActivity.class);
    ...
    @Override
    public FilterBrochureSeller getFilter() {
        if (filter == null) {
            filter = new FilterBrochureSeller(this, filterList);
        }
        return filter;
    }
    ...
    class HolderBrochureSeller extends RecyclerView.ViewHolder {
        ...
        //UI Views of the row_brochure.xml
